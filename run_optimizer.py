...
completeCV = True      # Per avere le predizioni sul train, impostarlo a True: parte dalla prima settimana del train
...
space_cat  = [
    ...
    Integer(400, 1200, name='iterations')
]
# 13.89245504314256 
# con
# params = {
...
res_gp = forest_minimize(objective_lgbm, space_lgbm, n_calls=50, random_state=42, verbose=False)
