...
for df_train, df_test in tqdm(gen):
    ...
    model = CatBoost(df_train, df_test, categorical_features=categorical_f, drop_columns=drop_cols, isScope=useScope,
    ...
    cluster_model_1 = CatBoost(df_train[df_train.cluster == 1], df_test[df_test.cluster == 1],
    ...
    #  -----------   Cluster 2
    cluster_model_2 = CatBoost(df_train[df_train.cluster == 2], df_test[df_test.cluster == 2],
                               categorical_features=categorical_f, drop_columns=drop_cols, name='_c', isScope=useScope,)
    ...
    if not useScope:
        #  -----------   Cluster 3
        cluster_model_3 = CatBoost(df_train[df_train.cluster == 3], df_test[df_test.cluster == 3],
